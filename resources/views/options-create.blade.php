            ...
            <div class="card-body">
                <form action="{{ route('admin.options.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="default_title" placeholder="Məs, Məhsulun vəziyyəti" name="default_title" value="{{old('default_title')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="default_type" name="default_type" aria-label="Default select example">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="default_required" name="default_required" aria-label="Default select example">
